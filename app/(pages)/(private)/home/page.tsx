...
export default function HomePage() {
  return (
    <div style={{ backgroundImage: `url(${AllData.BackgroundURL.data})` }} className="w-full h-screen bg-cover bg-center bg-no-repeat flex flex-col items-end justify-center">
